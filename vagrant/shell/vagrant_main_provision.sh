...
roles_list[0]='geerlingguy.memcached,1.0.7'
roles_list[1]='geerlingguy.ntp,1.4.0'
...
ansible-playbook /vagrant/ansible/playbook_development.yml -i /vagrant/ansible/inventories/development --connection=local
